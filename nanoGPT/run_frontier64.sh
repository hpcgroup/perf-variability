...
#SBATCH -t 01:00:00
#SBATCH -A csc547
#SBATCH --output /lustre/orion/csc547/scratch/keshprad/perfvar/nanoGPT_logs/64nodes/%x-%j/job-output.log
#SBATCH --error /lustre/orion/csc547/scratch/keshprad/perfvar/nanoGPT_logs/64nodes/%x-%j/job-error.log
#SBATCH --exclusive
...
export JOB_OUTPUT_PATH=/lustre/orion/csc547/scratch/keshprad/perfvar/nanoGPT_logs/64nodes/$SLURM_JOB_NAME-$SLURM_JOB_ID
