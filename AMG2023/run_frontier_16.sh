...
#SBATCH -t 00:45:00
#SBATCH -A csc547
#SBATCH --output /lustre/orion/csc547/scratch/keshprad/perfvar/AMG2023_logs/16nodes/%x-%j/job-output.log
#SBATCH --error /lustre/orion/csc547/scratch/keshprad/perfvar/AMG2023_logs/16nodes/%x-%j/job-error.log
#SBATCH --exclusive
...
OUTPUT_DIR=/lustre/orion/csc547/scratch/keshprad/perfvar/AMG2023_logs/16nodes/$SLURM_JOB_NAME-$SLURM_JOB_ID
