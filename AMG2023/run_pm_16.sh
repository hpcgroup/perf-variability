...
BASE_DIR="/pscratch/sd/c/cunyang/result/AMG2023/16nodes"
...
srun -n 64 -c 32 --gpus-per-node=4 --ntasks-per-node=4  --gpus-per-task=1   --gpu-bind=none  ./amg -P 4 4 4 -n 128 64 64 -problem 1 -iter 500 &> "$OUTPUT_DIR/amg.out"
